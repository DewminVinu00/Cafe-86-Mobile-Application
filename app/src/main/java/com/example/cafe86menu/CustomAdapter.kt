...
val desc:Array<String>) :RecyclerView.Adapter<CustomAdapter.CustomViewHolder>() {
    ...
    class CustomViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindValue(image: Int,texts: String,desc:String) {
            itemView.findViewById<ImageView>(R.id.imageView2).setImageResource(image)
            itemView.findViewById<TextView>(R.id.text1).text = texts
